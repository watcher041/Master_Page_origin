...
ActiveRecord::Schema.define(version: 2020_06_09_025318) do
  ...
  create_table "fields", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    t.string "name", null: false
